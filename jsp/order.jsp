...
Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/Restaurant","root","sbit");  
     Date obj=new Date(); 
	 ...
	 i=s.executeUpdate("insert into order1 values('"+s1+"','"+s2+"','"+s3+"','"+s4+"','"+s5+"','"+s6+"','"+obj+"')");
    }
	 catch(Exception e)
	  {
	  out.println(e);
...
<table width="100%" height="257">
  <tr valign="top">
		...
		<p><img src="../image/food delivery.jpg" width="190" height="280" /> </p>
    ...
    <p>&nbsp;</p></td><td width="54%" valign="top" align="left"><p><font size="+2" color="#990000">Delivery Order Form </font></p>
      <table width="414">
   <tr>
        <td width="87" height="48" align="right"><b>Customer ID</b></td>
 ...
 <tr>
      ...
      <tr>
		...
		<tr>
        <td width="87" height="34" align="right"><b>Food Item Name</b></td>
        <td width="272" align="left"><input type="text" name="t4" size="20"></td>
        </tr>
     <tr>
        <td width="87" height="45" align="right"><b>Food Type</b></td>
        ...
        <td width="23%"  valign="top" background=""><p><img src="../image/special_top.gif" width="202" height="67"></p><p><img src="../image/special_1.gif" width="202" height="67"></p>
          <p align="center"><img src="../image/burger.jpg" width="100" height="150"></p>
        <p align="center"><img src="../image/piza.gif" width="130" height="180"></p>
		<p align="center"><img src="../image/topmenu_right.gif" width="162" height="52"><br><img src="../image/top_pic.gif" width="162" height="59"></p>
			</td>
  </tr>
