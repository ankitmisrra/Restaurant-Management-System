...
<% int i=2;
    ...
    try
	 ...
	 // session.setAttribute("name",request.getParameter("uuid"));
	  ...
	  s=c.createStatement();
      r=s.executeQuery("select *from empregis");
     while(r.next())
       {
	  if(r.getString(9).equals(uname) && r.getString(10).equals(password))
        {
          i=1;
...
<table width="100%" height="257">
  <tr valign="top">
    <td width="20%" height="24" align="center"><p><strong>
      ...
      <p><img src="../image/food delivery.jpg" width="150" height="200" /></p>
      <p><img src="../image/food.jpg" width="150" height="200" /></p>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
      <p>&nbsp; </p>
      <p>&nbsp;</p>
    ...
    <td width="58%" valign="top" align="left"><p><font color="#990000" size="+2">Login Form: </font></p>
        <table width="567">
          ...
          <tr>
            ...
            <td align="left"><font color="#993300" size="+2">Employee Login:</font> </td>
          </tr>
          <tr>
