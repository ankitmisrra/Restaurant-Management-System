...
<table width="100%" height="257">
  <tr valign="top">
    <td width="20%" height="24" align="center"><p><strong>
      ...
      <p><font size="+1" color="#000099"><a href="adacc.jsp"><strong><img src="../image/back.jpg"  width="92" height="36"></strong></a></font></p>
    ...
    <td width="58%" valign="top" align="left"><p><font size="+2" color="#990000">Employee Registration Form </font></p>
        <table width="567">
          <tr>
            <td width="83" align="right"><b>Employee Name:</b></td>
          ...
          <tr>
            <td width="83" height="33" align="right"><b>EmailId:</b></td>
          ...
          <tr>
            ...
            <td width="472" align="left"><input name="submit" type="submit" value="Submit Form" /><input type="reset" value="Reset" /></td>
          </tr>
      </table></td>
