...
<form>
  ...
  <table width="100%" height="257" bgcolor= <body background="../image/bg2.jpg">
    ...
    <tr valign="top">
      ...
      <td width="82%" height="24" align="left" valign="top"><p><font size="+3" color="#996600">Food Item Feedback Form: </font><br />
              <font size="+2" color="#996600">Administrator can Check Feedback<br />
                Given by Customer .</font> </p><p align="right"><font size="+1" color="#000099"><a href="adacc.jsp"><strong><img src="../image/back.jpg"  width="92" height="36"></strong></a></font></p>
        <p align="center">
          <%
    Connection c;
    Statement s;
